...
const OrdersPaymentPending = () => {
  ...
  const { refetch: refetchReceiptImage, loading: loadingReceiptImage, data: dataReceiptImage } = useGet({ url: `https://bcknd.food2go.online/admin/payment/receipt/${orderId}` });
