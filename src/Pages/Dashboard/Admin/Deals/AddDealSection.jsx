...
import { AddButton, DateInput, DropDown, NumberInput, StaticButton, StaticLoader, SubmitButton, Switch, TextInput, TimeInput, UploadInput } from '../../../../Components/Components';
...
const AddDealSection = ({ refetch, setRefetch }) => {
       ...
       const handleReset = () => {
              ...
              dealTitle.map((name, index) => {
                     ...
                     setDealTitle(prev => {
                            ...
                            updatedNames[index] = {
                                   ...
                                   'deal_title': '', // Use the captured string value
              ...
              dealDescription.map((name, index) => {
                     ...
                     setDealDescription(prev => {
                            ...
                            updatedNames[index] = {
                                   ...updatedNames[index], // Retain existing properties if any
                                   'tranlation_id': '', // Use the ID from tap
                                   'deal_description': '', // Use the captured string value
                                   'tranlation_name': '', // Use tap.name for tranlation_name
                            };
